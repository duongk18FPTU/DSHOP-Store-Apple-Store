    ...
    <body>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-2 col-md-2 col-12">
                            ...
                            <div class="logo">
                                <a href="index.jsp"
                                   ><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/46/Apple_Store_logo.svg/2048px-Apple_Store_logo.svg.png" alt="logo"
                                      width="70px"
        ...
        <section class="hero-slider">
            ...
            <div class="single-slider"
                 style="background-image: url('https://www.wesalute.com/sites/default/files/styles/hero_image_front/public/2022-09/apple-landing-page.jpg?itok=KaI4P9QP');">
                <div class="container">
                            ...
                            <div class="text-inner">
                                <div class="row">
                                    <div class="col-lg-7 col-12">
                                        <div class="hero-text">
                                            <h1><span>UP TO 50% OFF </span>For Everyone</h1>
                                            <p>
